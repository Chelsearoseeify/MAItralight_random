...
def timer_interrupt(conn):
    global numbers,t,minute,n1,n2,index, index_mean,flag,phase,index_post,index_pre
    data_to_send = {"n1": 0, "n2": 0, "index_pre": 0, 'index_post': 'NaN'}    
    ...
    if flag==3:
      ...
      data_to_send['n1']= random.randint(1, 100)
      data_to_send['n2']= random.randint(1, 100)
      data_to_send['index_pre']= data_to_send['n2']/data_to_send['n1']
        
      print('n1= ', data_to_send['n1'])
      print('n2= ', data_to_send['n2'])
      ...
      if (t==10):
        ...
        if minute>=6:
            ...
            if phase==2:
              ...
              data_to_send['index_post']= data_to_send['n2']/data_to_send['n1']
              conn.sendall(json_data.encode('utf-8'))  # Send the JSON string as bytes
              phase=3
              flag=4
    if flag==4:
